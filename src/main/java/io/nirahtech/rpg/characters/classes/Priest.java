...
public final class Priest extends AbstractCharacterClass implements SpellDamager, SpellCurser, Heal, Guardian {
    
    public Priest() {
        super(ClassType.PRIEST, new Mana(200, 200));
        super.roles.addAll(Set.of(Role.DPS, Role.HEAL));
    }
