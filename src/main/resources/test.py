...
width, height = 800, 600
screen = pygame.display.set_mode((width, height))
pygame.display.set_caption("Droite entre deux points avec extrémités sur les bords")

# Couleur de la droite (blanche)
line_color = (255, 255, 255)

# Points de départ (coordonnées x, y)
point1 = (200, 100)
point2 = (600, 500)
...
# Déterminez la bordure sur laquelle la droite s'appuie (par exemple, la bordure supérieure)
border = "top"

# Calculez les coordonnées x des points supplémentaires sur la bordure choisie
x1 = 0
x2 = width

# Utilisez la pente pour calculer les coordonnées y correspondantes
y1 = point1[1] - slope * (point1[0] - x1)
y2 = point1[1] - slope * (point1[0] - x2)
...
while running:
    ...
    # Dessine la droite entre les deux points de départ
    pygame.draw.line(screen, line_color, point1, point2, 2)

    # Dessine la ligne entre les deux points supplémentaires sur la bordure
